...
public class FirebaseUtility {
    ...
    public static String getCurrentUserID(){
        return FirebaseUtility.getCurrentUser() != null ? FirebaseUtility.getCurrentUser().getUid() : "";
    }
     ...
     * query chats
     */
    public static void queryChatMessages(String selectedUserID){
        Query queryChatMessages = FirebaseUtility.getFireBaseChatRoomDatabaseReference()
                .child(FirebaseUtility.generateUniqueID(selectedUserID))
                .orderByKey()
                .limitToLast(5);
    ...
    public static String generateUniqueID(String userID){
        ...
        uniqueID.append(userID)
                .append(FirebaseUtility.getCurrentUserID());
